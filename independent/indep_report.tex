...
Linear interpolation is the simplest way of getting the values between points. Linear interpolation is a method to fit a curve to the points using linear functions. if we know the coordinate of two points as $(x_0,y_0)$ and $(x_1,y_1)$, the linear interpolation between these two points would just be a straight line. The equation of a straight line is given by
\begin{equation}
...
\end{figure}
\FloatBarrier
Figure 2 shows that as we add more knots, the interpolated curves get more similar to the function because the line segments get smaller and more accurate between points with increasing number of knots.
...
The estimate of the interpolated function would then be:
\begin{equation}
f(x,y) = \frac{1}{(x_2-x_1)(y_2-y_1)} \left ( f(Q_{11})(x_2-x)(y_2-y) + 
\\f(Q_{21})(x-x_1)(y_2-y) + 
\\f(Q_{12})(x_2-x)(y-y_1) + 
